...
if __name__ == '__main__':
    ...
    parser.add_argument('--scene_path', type=str, default='scene1111_11') # /home/yswang/server160data2/scans/scene0000_00
    args = parser.parse_args()

    print('Loading model...')
    net = PL3DVNet.load_from_checkpoint('3dvnet/3dvnet_weights/epoch=100-step=60700.ckpt')
    dset_kwargs = {
        'img_size': (256, 320)
    }
    main('3dvnet', process_scene, dset_kwargs, net, depth=True,scene=args.scene_path)
